...
OPENAI_TRAINING_MODEL = _env_str("OPENAI_TRAINING_MODEL", "gpt-5.6")
OPENAI_TRAINING_TIMEOUT_SECONDS = int(
    os.getenv("OPENAI_TRAINING_TIMEOUT_SECONDS", "90")
)
OPENAI_TRAINING_REASONING_EFFORT = _env_str(
    "OPENAI_TRAINING_REASONING_EFFORT", "medium"
)
OPENAI_TRAINING_WEB_SEARCH = _env_bool("OPENAI_TRAINING_WEB_SEARCH", True)
