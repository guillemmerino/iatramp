...
INSTALLED_APPS = [
    ...
    "iatrain_biomechanics.apps.IatrainBiomechanicsConfig",
    "iatrain_exercises.apps.IatrainExercisesConfig",
...
OPENAI_TRAINING_MODEL = _env_str("OPENAI_TRAINING_MODEL", "gpt-5.6-luna")
OPENAI_TRAINING_TIMEOUT_SECONDS = int(
    os.getenv("OPENAI_TRAINING_TIMEOUT_SECONDS", "120")
)
OPENAI_TRAINING_REASONING_EFFORT = _env_str(
    "OPENAI_TRAINING_REASONING_EFFORT", "medium"
)
OPENAI_TRAINING_WEB_SEARCH = _env_bool("OPENAI_TRAINING_WEB_SEARCH", False)
OPENAI_TRAINING_MAX_TOOL_ROUNDS = int(
    os.getenv("OPENAI_TRAINING_MAX_TOOL_ROUNDS", "20")
)
OPENAI_TRAINING_MAX_TOOL_CALLS = int(
    os.getenv("OPENAI_TRAINING_MAX_TOOL_CALLS", "50")
)
OPENAI_TRAINING_MAX_RESULTS_PER_SEARCH = int(
    os.getenv("OPENAI_TRAINING_MAX_RESULTS_PER_SEARCH", "20")
)
OPENAI_TRAINING_MAX_UNIQUE_CANDIDATES = int(
    os.getenv("OPENAI_TRAINING_MAX_UNIQUE_CANDIDATES", "100")
)
OPENAI_TRAINING_MAX_REPAIRS = int(os.getenv("OPENAI_TRAINING_MAX_REPAIRS", "2"))
OPENAI_TRAINING_MAX_EVIDENCE_ROUNDS = int(
    os.getenv("OPENAI_TRAINING_MAX_EVIDENCE_ROUNDS", "3")
)
OPENAI_TRAINING_MAX_REVIEW_REPAIRS = int(
    os.getenv("OPENAI_TRAINING_MAX_REVIEW_REPAIRS", "1")
)
OPENAI_TRAINING_MAX_OUTPUT_TOKENS = int(
    os.getenv("OPENAI_TRAINING_MAX_OUTPUT_TOKENS", "9000")
)
OPENAI_TRAINING_MAX_LIVE_HISTORY_BYTES = int(
    os.getenv("OPENAI_TRAINING_MAX_LIVE_HISTORY_BYTES", "100000")
)
OPENAI_TRAINING_MAX_RATE_LIMIT_RETRIES = int(
    os.getenv("OPENAI_TRAINING_MAX_RATE_LIMIT_RETRIES", "2")
)
OPENAI_TRAINING_MAX_RATE_LIMIT_WAIT_SECONDS = int(
    os.getenv("OPENAI_TRAINING_MAX_RATE_LIMIT_WAIT_SECONDS", "60")
)
OPENAI_TRAINING_REVIEW_ENABLED = _env_bool(
    "OPENAI_TRAINING_REVIEW_ENABLED", True
)
OPENAI_TRAINING_PLANNING_BRIEF_ENABLED = _env_bool(
    "OPENAI_TRAINING_PLANNING_BRIEF_ENABLED", True
)
OPENAI_TRAINING_REVIEW_MODEL = _env_str(
    "OPENAI_TRAINING_REVIEW_MODEL", OPENAI_TRAINING_MODEL
)
OPENAI_TRAINING_REVIEW_REASONING_EFFORT = _env_str(
    "OPENAI_TRAINING_REVIEW_REASONING_EFFORT", "medium"
)
OPENAI_TRAINING_REVIEW_MAX_OUTPUT_TOKENS = int(
    os.getenv("OPENAI_TRAINING_REVIEW_MAX_OUTPUT_TOKENS", "3500")
)
